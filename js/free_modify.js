...
let ftitle = localStorage.getItem('ftitle');

document.getElementById('free_title').value = localStorage.getItem('ftitle');
document.getElementById('free_content').value = localStorage.getItem('fcontent');
